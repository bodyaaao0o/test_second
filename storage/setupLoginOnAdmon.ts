...
(async () => {
    ...
    await page.goto('https://www.staging.admin.penomo.com/');
    ...
    await context.storageState({ path: 'auth/AdminPage.json' });

    console.log('✅ Сесію збережено у auth/AdminPage.json');
